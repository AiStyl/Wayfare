...
const destinationData: Record<string, { activities: Activity[]; tips: string[] }> = {
  'Tokyo': {
    activities: [
      { time: '09:00', title: 'Senso-ji Temple', description: 'Tokyo\'s oldest and most famous Buddhist temple in Asakusa', type: 'attraction', duration: '2 hours', cost: 'Free', tip: 'Go early to avoid crowds and explore Nakamise shopping street', bookUrl: 'https://www.viator.com/Tokyo-tours/Sensoji-Temple/d334-a26942' },
      ...
      { time: '14:00', title: 'teamLab Borderless', description: 'Immersive digital art museum experience', type: 'activity', duration: '3 hours', cost: '$30', tip: 'Book tickets online 2+ weeks ahead', bookUrl: 'https://www.viator.com/Tokyo-tours/teamLab/d334-g26942' },
      ...
      { time: '19:30', title: 'Izakaya Dinner in Shinjuku', description: 'Traditional Japanese pub experience with small plates', type: 'food', duration: '2 hours', cost: '$30-50', tip: 'Try yakitori, edamame, and sake', bookUrl: 'https://www.viator.com/Tokyo-tours/Food-Tours/d334-g6-c81' },
      ...
      { time: '14:00', title: 'Tokyo Skytree', description: 'Observation deck with panoramic city views', type: 'attraction', duration: '2 hours', cost: '$20', tip: 'Go near sunset for day and night views', bookUrl: 'https://www.viator.com/Tokyo-tours/Tokyo-Skytree/d334-a17295' },
  ...
  'Paris': {
    activities: [
      { time: '09:00', title: 'Eiffel Tower', description: 'Iconic iron lattice tower with city views from 3 levels', type: 'attraction', duration: '2-3 hours', cost: '$30', tip: 'Book skip-the-line tickets online', bookUrl: 'https://www.viator.com/Paris-tours/Eiffel-Tower/d479-a649' },
      ...
      { time: '15:00', title: 'Louvre Museum', description: 'World\'s largest art museum - Mona Lisa, Venus de Milo', type: 'attraction', duration: '3-4 hours', cost: '$20', tip: 'Enter through Porte des Lions for shorter queues', bookUrl: 'https://www.viator.com/Paris-tours/Louvre-Museum/d479-a26861' },
      { time: '19:30', title: 'Seine River Cruise', description: 'Evening boat tour past illuminated monuments', type: 'activity', duration: '1 hour', cost: '$15-25', tip: 'Book a dinner cruise for special occasions', bookUrl: 'https://www.viator.com/Paris-tours/Seine-River/d479-a27006' },
      ...
      { time: '16:00', title: 'Musée d\'Orsay', description: 'Impressionist masterpieces in a former railway station', type: 'attraction', duration: '2-3 hours', cost: '$16', tip: 'Free first Sunday of month', bookUrl: 'https://www.viator.com/Paris-tours/Musee-dOrsay/d479-a27033' },
      ...
      { time: '10:00', title: 'Palace of Versailles', description: 'Opulent royal château with Hall of Mirrors and gardens', type: 'attraction', duration: '5-6 hours', cost: '$20', tip: 'Go on weekdays - extremely crowded on weekends', bookUrl: 'https://www.viator.com/Paris-tours/Versailles/d479-a529' },
  ...
  'New York': {
    activities: [
      ...
      { time: '10:30', title: 'Metropolitan Museum of Art', description: 'World-class art spanning 5,000 years', type: 'attraction', duration: '3 hours', cost: '$30', tip: 'Focus on 2-3 sections - it\'s massive', bookUrl: 'https://www.viator.com/New-York-City-tours/Metropolitan-Museum-of-Art/d687-a26947' },
      { time: '14:00', title: 'Times Square & Broadway', description: 'Bright lights, theaters, and iconic billboards', type: 'attraction', duration: '1.5 hours', cost: 'Free', tip: 'Book Broadway tickets at TKTS booth for same-day discounts', bookUrl: 'https://www.viator.com/New-York-City-tours/Broadway-Shows/d687-g6-c26' },
      ...
      { time: '09:00', title: 'Statue of Liberty & Ellis Island', description: 'Iconic symbol of freedom and immigration museum', type: 'attraction', duration: '4-5 hours', cost: '$24', tip: 'Book crown access months ahead', bookUrl: 'https://www.viator.com/New-York-City-tours/Statue-of-Liberty/d687-a16867' },
      ...
      { time: '10:00', title: '9/11 Memorial & Museum', description: 'Moving tribute with reflecting pools and artifacts', type: 'attraction', duration: '2-3 hours', cost: '$33', tip: 'Memorial is free, museum requires ticket', bookUrl: 'https://www.viator.com/New-York-City-tours/911-Memorial-Museum/d687-a26946' },
      { time: '14:00', title: 'Top of the Rock or Empire State', description: 'Observation decks with Manhattan skyline views', type: 'attraction', duration: '1.5 hours', cost: '$40', tip: 'Top of the Rock has better views of Empire State', bookUrl: 'https://www.viator.com/New-York-City-tours/Empire-State-Building/d687-a649' },
  ...
  'Las Vegas': {
    activities: [
      ...
      { time: '15:00', title: 'High Roller Observation Wheel', description: '550-foot tall wheel with Strip views', type: 'attraction', duration: '1 hour', cost: '$25-37', tip: 'Book the happy hour pod for open bar', bookUrl: 'https://www.viator.com/Las-Vegas-tours/High-Roller/d684-a15674' },
      { time: '17:00', title: 'The Venetian & Grand Canal', description: 'Indoor canals with gondola rides and Italian architecture', type: 'attraction', duration: '1.5 hours', cost: 'Free to walk / $35 gondola', tip: 'Gondola rides are romantic but pricey', bookUrl: 'https://www.viator.com/Las-Vegas-tours/Gondola-Rides/d684-g25351' },
      { time: '19:30', title: 'Gordon Ramsay Hell\'s Kitchen', description: 'Celebrity chef restaurant at Caesars Palace', type: 'food', duration: '2 hours', cost: '$60-100', tip: 'Make reservations 2+ weeks ahead', bookUrl: 'https://www.viator.com/Las-Vegas-tours/Dining-Experiences/d684-g6-c81' },
      { time: '22:00', title: 'Cirque du Soleil Show', description: 'World-famous acrobatic performances - O, KA, or Mystère', type: 'activity', duration: '2 hours', cost: '$100-200', tip: '"O" at Bellagio is the most spectacular', bookUrl: 'https://www.viator.com/Las-Vegas-tours/Cirque-du-Soleil/d684-g25287' },
      { time: '09:00', title: 'Grand Canyon Day Trip', description: 'Helicopter or bus tour to the South or West Rim', type: 'activity', duration: '8-12 hours', cost: '$150-500', tip: 'Helicopter tours include stunning aerial views', bookUrl: 'https://www.viator.com/Las-Vegas-tours/Grand-Canyon/d684-g21474' },
      ...
      { time: '14:00', title: 'Mob Museum', description: 'Interactive museum about organized crime history', type: 'attraction', duration: '2 hours', cost: '$30', tip: 'Includes speakeasy bar in the basement', bookUrl: 'https://www.viator.com/Las-Vegas-tours/Mob-Museum/d684-a12889' },
  ...
  'London': {
    activities: [
      { time: '09:00', title: 'Tower of London', description: 'Historic castle, Crown Jewels, and Beefeater tours', type: 'attraction', duration: '3 hours', cost: '£30', tip: 'Arrive at opening to see Crown Jewels without crowds', bookUrl: 'https://www.viator.com/London-tours/Tower-of-London/d737-a649' },
      ...
      { time: '17:00', title: 'Westminster Abbey & Big Ben', description: 'Gothic church and iconic clock tower', type: 'attraction', duration: '1.5 hours', cost: '£25 for Abbey', tip: 'Big Ben chimes on the hour - time your visit', bookUrl: 'https://www.viator.com/London-tours/Westminster-Abbey/d737-a27033' },
      { time: '19:30', title: 'West End Theatre Show', description: 'World-class musicals and plays', type: 'activity', duration: '2.5 hours', cost: '£40-150', tip: 'TKTS booth in Leicester Square for same-day discounts', bookUrl: 'https://www.viator.com/London-tours/Theater-Shows/d737-g25298' },
      ...
      { time: '10:00', title: 'Harry Potter Studio Tour', description: 'Behind-the-scenes of the film series', type: 'activity', duration: '4 hours', cost: '£50', tip: 'Book weeks ahead - always sells out', bookUrl: 'https://www.viator.com/London-tours/Harry-Potter/d737-g25303' },
  ...
  'Barcelona': {
    activities: [
      { time: '09:00', title: 'La Sagrada Familia', description: 'Gaudí\'s unfinished masterpiece - stunning basilica', type: 'attraction', duration: '2 hours', cost: '€26', tip: 'Book online weeks ahead - always sells out', bookUrl: 'https://www.viator.com/Barcelona-tours/Sagrada-Familia/d562-a649' },
      ...
      { time: '16:00', title: 'Park Güell', description: 'Gaudí\'s colorful mosaic park with city views', type: 'attraction', duration: '2 hours', cost: '€10', tip: 'Book timed entry in advance', bookUrl: 'https://www.viator.com/Barcelona-tours/Park-Guell/d562-a17296' },
      ...
      { time: '21:30', title: 'Flamenco Show', description: 'Traditional Spanish dance performance', type: 'activity', duration: '1.5 hours', cost: '€35-50', tip: 'Tablao Cordobes or Palau de la Música for authentic shows', bookUrl: 'https://www.viator.com/Barcelona-tours/Flamenco/d562-g25287' },
      ...
      { time: '14:00', title: 'Casa Batlló', description: 'Gaudí\'s dragon-inspired house on Passeig de Gràcia', type: 'attraction', duration: '1.5 hours', cost: '€35', tip: 'Evening visits include live music on the rooftop', bookUrl: 'https://www.viator.com/Barcelona-tours/Casa-Batllo/d562-a17295' },
  ...
  'Rome': {
    activities: [
      { time: '08:30', title: 'Vatican Museums & Sistine Chapel', description: 'World\'s greatest art collection and Michelangelo\'s ceiling', type: 'attraction', duration: '4 hours', cost: '€20', tip: 'Book first entry slot to avoid crushing crowds', bookUrl: 'https://www.viator.com/Rome-tours/Vatican-Museums/d511-a649' },
      ...
      { time: '15:00', title: 'Colosseum & Roman Forum', description: 'Ancient amphitheater and heart of Roman Empire', type: 'attraction', duration: '3 hours', cost: '€18', tip: 'Combined ticket includes Palatine Hill', bookUrl: 'https://www.viator.com/Rome-tours/Colosseum/d511-a649' },
      ...
      { time: '15:00', title: 'Borghese Gallery', description: 'Masterpieces by Bernini, Caravaggio, Raphael', type: 'attraction', duration: '2 hours', cost: '€15', tip: 'Reservation mandatory - book weeks ahead', bookUrl: 'https://www.viator.com/Rome-tours/Borghese-Gallery/d511-a26947' },
  ...
  'Dubai': {
    activities: [
      { time: '09:00', title: 'Burj Khalifa At The Top', description: 'World\'s tallest building - observation deck at 555m', type: 'attraction', duration: '2 hours', cost: '$45', tip: 'Book sunrise or sunset slot for best photos', bookUrl: 'https://www.viator.com/Dubai-tours/Burj-Khalifa/d828-a649' },
      ...
      { time: '07:00', title: 'Desert Safari', description: 'Dune bashing, camel rides, BBQ dinner, and entertainment', type: 'activity', duration: '6 hours', cost: '$60-100', tip: 'Book a morning safari to avoid afternoon heat', bookUrl: 'https://www.viator.com/Dubai-tours/Desert-Safari/d828-g21482' },
      ...
      { time: '15:00', title: 'Dubai Frame', description: 'Iconic landmark with views of old and new Dubai', type: 'attraction', duration: '1 hour', cost: '$15', tip: 'Glass floor bridge is thrilling', bookUrl: 'https://www.viator.com/Dubai-tours/Dubai-Frame/d828-a38759' },
      { time: '20:00', title: 'Dhow Cruise Dinner', description: 'Traditional boat dinner cruise on Dubai Creek', type: 'activity', duration: '2 hours', cost: '$60', tip: 'Marina cruises are fancier, Creek cruises more authentic', bookUrl: 'https://www.viator.com/Dubai-tours/Dhow-Cruise/d828-g25287' },
    ],
    tips: ['Friday is weekend - malls get crowded', 'Dress modestly in old Dubai', 'Metro is excellent and cheap'],
  },
  'Bali': {
    activities: [
      { time: '06:00', title: 'Mount Batur Sunrise Trek', description: 'Active volcano hike with stunning sunrise views', type: 'activity', duration: '6 hours', cost: '$50-80', tip: 'Start at 2am to reach summit for sunrise', bookUrl: 'https://www.viator.com/Bali-tours/Mount-Batur/d282-a649' },
      ...
      { time: '16:00', title: 'Sacred Monkey Forest', description: 'Temple complex in jungle with playful macaques', type: 'nature', duration: '1.5 hours', cost: '$5', tip: 'Secure all belongings - monkeys will grab anything', bookUrl: 'https://www.viator.com/Bali-tours/Monkey-Forest/d282-a17296' },
      { time: '18:30', title: 'Uluwatu Temple Sunset & Kecak Dance', description: 'Clifftop temple with traditional fire dance performance', type: 'attraction', duration: '2.5 hours', cost: '$15', tip: 'Arrive 1 hour early for good seats at Kecak show', bookUrl: 'https://www.viator.com/Bali-tours/Uluwatu-Temple/d282-a12889' },
      ...
      { time: '11:30', title: 'Bali Swing', description: 'Insta-famous jungle swings with valley views', type: 'activity', duration: '1.5 hours', cost: '$35', tip: 'Wanagiri Hidden Hills has multiple swings with fewer crowds', bookUrl: 'https://www.viator.com/Bali-tours/Bali-Swing/d282-a38759' },
      ...
      { time: '10:00', title: 'Snorkeling at Nusa Penida', description: 'Day trip to see manta rays and crystal-clear water', type: 'activity', duration: '8 hours', cost: '$80-120', tip: 'Book a tour that includes Kelingking Beach viewpoint', bookUrl: 'https://www.viator.com/Bali-tours/Nusa-Penida/d282-g21474' },
    ],
  ...
  'Amsterdam': {
    activities: [
      { time: '09:00', title: 'Anne Frank House', description: 'Moving museum in the secret annex where Anne hid', type: 'attraction', duration: '1.5 hours', cost: '€16', tip: 'Book online exactly 6 weeks ahead - sells out instantly', bookUrl: 'https://www.viator.com/Amsterdam-tours/Anne-Frank-House/d525-a649' },
      { time: '11:00', title: 'Canal Boat Tour', description: 'See the city from its famous waterways', type: 'activity', duration: '1 hour', cost: '€15-20', tip: 'Open-top boats are best in good weather', bookUrl: 'https://www.viator.com/Amsterdam-tours/Canal-Cruises/d525-g6-c76' },
      ...
      { time: '14:30', title: 'Rijksmuseum', description: 'Dutch masterpieces including Rembrandt\'s Night Watch', type: 'attraction', duration: '3 hours', cost: '€22.50', tip: 'Focus on Gallery of Honour for the highlights', bookUrl: 'https://www.viator.com/Amsterdam-tours/Rijksmuseum/d525-a649' },
      ...
      { time: '10:00', title: 'Van Gogh Museum', description: 'World\'s largest collection of Van Gogh\'s work', type: 'attraction', duration: '2 hours', cost: '€22', tip: 'Audio guide is excellent and included', bookUrl: 'https://www.viator.com/Amsterdam-tours/Van-Gogh-Museum/d525-a17295' },
      ...
      { time: '15:00', title: 'Heineken Experience', description: 'Interactive tour of the original Heineken brewery', type: 'activity', duration: '1.5 hours', cost: '€23', tip: 'Includes two beers - pour your own at the end', bookUrl: 'https://www.viator.com/Amsterdam-tours/Heineken-Experience/d525-a12889' },
          ...
          {itinerary && (
            <div className="max-w-4xl mx-auto mb-16 animate-fade-in">
              ...
              <div className="mt-6 flex flex-wrap gap-4 justify-center">
                ...
                <a
                  href={`https://www.viator.com/searchResults/all?text=${encodeURIComponent(destination + ' tours and activities')}`}
                  target="_blank"
                  rel="noopener noreferrer"
